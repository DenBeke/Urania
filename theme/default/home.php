			...
			foreach ($this->albums as $album) {			
				...
				<li>
					<a href="<?php echo SITE_URL; ?>album/<?php echo $album->getId(); ?>/<?php echo $this->urania->simplifyFileName($album->getName()); ?>" title="<?php echo $album->getName(); ?>">
						<div class="home-album-image-container" style="background-image: url(<?php echo SITE_URL; ?>core/timthumb.php?src=<?php echo $album->getImage(0)->getFileName() . "&amp;h=" . 2 * $imageHeight . "&amp;w=" . 2 * $imageWidth; ?>);">
